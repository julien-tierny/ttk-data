...
tTKScalarFieldCriticalPoints2 = TTKScalarFieldCriticalPoints(Input=tTKArrayPreconditioning1)
...
tTKIntegralLines1 = TTKIntegralLines(Domain=tTKArrayPreconditioning1,
    Seeds=threshold4)
...
resampleWithDataset1 = ResampleWithDataset(SourceDataArrays=cellDatatoPointData1,
